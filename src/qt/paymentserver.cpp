...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click landcoin: links)
...
{
    // clicking on landcoin: URLs creates FileOpen events on the Mac:
